...
AsyncStorage.clear.apply
      ...
      return(
        <View style= {{flex:1, backgroundColor: '#2F4F4F'}}>
          ...
          <Image source= {require('../../Imagens/logoarvore.png')} style={{left: 90, marginTop: -60}} />
          <Text style={{fontSize: 45, left:80, color: '#FFF' }}>Linked Park</Text>
          <Text style={{fontSize: 20, left:100, color: '#FFF'}}>O lazer ligado a você</Text>
